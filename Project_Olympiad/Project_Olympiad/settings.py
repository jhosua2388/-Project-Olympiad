"""
Django settings for Project_Olympiad project.
...
SECRET_KEY = 'django-insecure-esoldb_a^gan)^%n6-qdi=4-$5&n0+-9@(bf=hp2qu2+%&!(xe'
...
ROOT_URLCONF = 'Project_Olympiad.urls'
...
WSGI_APPLICATION = 'Project_Olympiad.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ong_proyecto', #BASE_DIR / 'db.sqlite3',
        'USER': 'postgres',
        'PASSWORD': 'j18428128',
        'HOST': '127.0.0.1',
        'PORT': '5432',
